...
export default function TechScroller() {
  ...
  return (
    <div className="relative overflow-x-hidden py-8 mt-10 dark:text-white/80 bg-custPrim dark:bg-darkCust">
      <div
          ...
          >
            <div className="p-2 rounded-full">
              <img
                src={`/svg/${tech}.svg`}
                alt={tech}
                className="h-7 w-auto object-contain transition-transform group-hover:scale-110 dark:opacity-60 "
                width="30"
                height="30"
                loading="lazy"
              />
