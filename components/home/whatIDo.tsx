...
export default function WhatDoIDo() {
  return <div className="pt-10 relative">
    <h1 className="flex flex-row items-center justify-center gap-1">
      ...
      <ShinyText text="About Me" speed={5} disabled={false} className='text-lg font-extralight text-green-500 dark:text-last' />
    </h1>
    <BlurText
      text="I&apos;m a full-stack software developer with 2+ years of experience, focused on backend systems but also skilled in frontend and mobile development. I love solving problems, building efficient solutions, and bringing ideas to life through code."
      delay={100}
      animateBy="words"
      direction="top"
      className="mb-8 py-2 justify-center mx-4 text-center text-3xl dark:text-white/90 font-extralight"
    />
  </div>
}
