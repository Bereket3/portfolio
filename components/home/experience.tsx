...
const ExperienceTimeline: React.FC = () => {
  return (
    <div className="relative w-full max-w-screen-xl md:px-20 flex flex-col items-left">
          ...
          <Accordion type="single" collapsible className="">
            {experienceData.map((item, index) => (
              <AccordionItem
                ...
                className="w-[100%]"
              >
                <AccordionTrigger className="flex flex-row items-center content-center justify-between w-[100%]">
                  ...
                  <div className="text-muted-foreground md:text-sm text-xs mt-2">
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      {item.skills.map((skill, index) => (
                        <Badge
                          variant="secondary"
                          className="dark:bg-custPrim/20 dark:text-white"
                          key={index}
                        >
                          <div
                            className={`${getRandomColor()} w-2 h-2 mr-2 rounded-full`}
